...
## Summary
- 515 nodes · 837 edges · 21 communities (17 shown, 4 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4752a1ea`
...
Cohesion: 0.06
Nodes (31): drizzle-kit, devDependencies, drizzle-kit, tailwindcss, @tailwindcss/cli, @tailwindcss/vite, @types/bun, @types/node (+23 more)
...
## Knowledge Gaps
- **247 isolated node(s):** `name`, `module`, `type`, `private`, `dev` (+242 more)
